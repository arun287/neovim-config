" vim:fdm=marker Vim Color File Name:       onedark.vim Maintainer: https://github.com/joshdick/onedark.vim/ License:    The MIT License (MIT) Based On:   https://github.com/MaxSt/FlatColor/ A companion [vim-airline](https://github.com/bling/vim-airline) theme is available at: https://github.com/joshdick/airline-onedark.vim
...
call s:h("String", { "fg": s:cyan }) " a string constant: "this is a string"
...
call s:h("Type", { "fg": s:dark_yellow }) " int, long, char, etc.
call s:h("StorageClass", { "fg": s:yellow }) " static, register, volatile, etc.
call s:h("Structure", { "fg": s:dark_yellow }) " struct, union, enum, etc.
